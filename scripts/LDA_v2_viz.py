...
class LDA():
    ...
    def plot_decision_boundary(self,X,y):
        ...
        # 然后画出图
        plt.title("Fisher linear classifier by Motingyu")
    ...
    def viz(self, X,y):
        ...
        plt.scatter(X[:,0], X[:,1], s=40, c=y,cmap=plt.cm.Spectral) #画出特征点
        plt.show()
...
if __name__=="__main__":
    ...
    Fisher.viz(np.vstack((w1_features,w2_features)),np.hstack((w1_labels,w2_labels)))
